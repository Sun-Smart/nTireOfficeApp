...
//private qrScanner: QRScanner
  ...
  processassettransfer(){
    ...
    var dataub = {
      ...
      'oldbranchid': this.detailfromidbranch,
      'ubranchid': this.tobranch,
      'assetid': this.detailassetid,
      'assetdepart': this.detailassetdepart,
      'assetownerid': this.detailownerid,
      'assetcategory': this.detailassetcategory,
  ...
  processassettransferi(){
    ...
    var dataubi = {
      ...
      'oldbranchid': this.detailfromidbranchi,
      // 'ubranchid': this.tobranch,
      'remarks':this.remarksi,
      'assetid': this.detailassetidi,
      'assetdepart': this.detailassetdeparti,
      'assetownerid': this.detailowneridi,
      'assetcategory': this.detailassetcategoryi,
      'dateins': finaltodayDate,
      'createbytf': this.userID,
      'access_token':this.accessToken,
      'userid': this.userID,
